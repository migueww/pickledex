          ...
          {error && (
            <div className="max-w-md mx-auto bg-white border border-rose-200 rounded-lg p-6 text-center flex flex-col items-center gap-3" role="alert">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-line">{error}</p>
              </div>
              <button
...
export default function Home() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center flex-col gap-3">
          <div className="w-8 h-8 border-2 border-emerald-600 border-t-transparent rounded-full animate-spin"></div>
